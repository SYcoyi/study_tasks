...
class RedisClient(object):
    # def __init__(self, url='redis://:froad@localhost:6379/2'):
    #     self.redis = redis.from_url(url=url)
    
    def __init__(self, url='redis://@10.43.1.138:13220/0'):
        self.redis = redis.from_url(url=url)
...
if __name__ == '__main__':
    redis = RedisClient()
    bb = redis.batch_fetch('finger:bank:verify_img_token:3b34825cb02f47e9a8cbf5a4240e1287')
    # print(bb)
    for i in bb:
        print(i)
